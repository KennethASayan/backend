...
// DMS Routes
Route::get('dms/getDueDocuments', 'DmsController@getDueDocuments');
Route::post('dms/login', 'DmsAuthController@login');// DMS Routes
Route::get('dms/logout', 'DmsAuthController@logout');
Route::get('dms/user', 'DmsAuthController@user');
